...
const SOURCES = [
  ...
  },
  {
    id: 'EUROPE_PMC',
    name: 'Europe PMC',
    logoSrc: '/source-logos/europe-pmc.svg',
    logoAlt: 'Europe PMC logo',
    logoWidth: 220,
    logoHeight: 64,
    status: 'active',
    description:
      'Biomedical full-text and metadata source. Automatic sync is supported with no extra credentials and adds PMID/PMCID-aware duplicate reuse.',
    fields: [],
  ...
  },
  {
    id: 'OPENALEX',
    name: 'OpenAlex',
    logoSrc: '/source-logos/openalex.svg',
    logoAlt: 'OpenAlex logo',
    logoWidth: 220,
    logoHeight: 64,
    status: 'active',
    description:
      'Open research graph source. Automatic sync is supported for researchers with ORCID iDs or verified OpenAlex author IDs, and contributes citation-aware work metadata.',
    fields: [{ key: 'openAlexEmail', label: 'Polite Pool Email', placeholder: 'research@slu.edu', type: 'email' }],
